...
class TTAMethod(nn.Module):
    def __init__(self, cfg, model, num_classes):
        ...
        self.is_augmentations = 0
        self.entropy_teacher = 0
        self.entropy_student = 0
        self.entropy_anchor = 0
        self.entropy_cross = 0
        ...
        self.feature_extractor, self.classifier = split_up_model(self.model, arch_name, self.dataset_name, split2=True)
    ...
    def forward(self, x, need_feature=False):
        ...
        if x[0].shape[0] == 1:  # single sample test-time adaptation
            ...
            for _ in range(self.steps):
                ...
                if need_feature:
                    outputs, outputs_feature, outputs_feature_ema, outputs_feature_anchor = self.forward_and_adapt(x)
                    return outputs, outputs_feature, outputs_feature_ema, outputs_feature_anchor
    ...
    def get_is_augmentations(self):
        return self.is_augmentations
